...
// ─── SEO Setup ──────────────────────────────────────────────────
$page_title     = e($product['name']) . ' Review ' . SITE_YEAR . ' — ' . $product['badge'] . ' | ' . SITE_NAME;
  ...
  <div class="container">
    <div class="review-hero__inner">
      ...
      <div class="review-hero__content">
        <span class="award review-hero__award <?= $product['badge'] === "Steve's #1 Pick" ? 'award--overall' : ($product['badge'] === 'Best Budget Pick' ? 'award--budget' : 'award--value') ?>">
          <?= e($product['badge']) ?> — <?= e($cat['name']) ?>
        </span>
        <?php if (!empty($product['award'])): ?>
          <span class="award award--third-party" style="margin-left:0.5rem;"><?= e($product['award']) ?></span>
        <?php endif; ?>
...
<div class="review-body">
  <div class="container">
    ...
    <!-- Steve's Verdict -->
    <h2>Steve's Verdict: <?= e($product['badge']) ?></h2>
    <p><?= e($product['description']) ?></p>

    <!-- Steve's Video Review -->
    <?= render_video($product['video'] ?? '') ?>
    ...
    <p style="font-size: 0.75rem; color: #9ca3af; text-align: center; margin-top: 1rem;">
      <em>Affiliate disclosure: SteveGet earns a commission on purchases made through our links at no extra cost to you. <a href="/disclosure.html">Learn more</a>.</em>
    </p>
...
<section class="related-section">
  <div class="container">
    ...
    <div class="text-center mt-8">
      <a href="/category/<?= e($cat['slug']) ?>.html" class="cta-link">
