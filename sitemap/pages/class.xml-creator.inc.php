        ...
        )
        {
          if($l2 = iconv($this->runstate['charset'], 'UTF-8', $Z8F0gPCCw_jy))
            $Z8F0gPCCw_jy = $l2;
                                                    ...
                                                    $this->C4gRMxIl1(bvxoWXIyZCcaoVlsa.$sf.$gp,$this->W4gG28CLjg.$sf.$gp);
