  ...
  <div class="container">
    ...
    <div class="category-grid">
      <?php foreach ($categories as $slug => $cat): ?>
        <a href="/category.php?cat=<?= e($slug) ?>" class="category-card">
          <img
            src="<?= e($cat['image']) ?>"
...
<section class="section section--alt">
  <div class="container">
    ...
    <div class="featured-grid">
      ...
      $featured = array_filter($products, fn($p) => $p['award'] === 'Best Overall');
      ...
      ?>
        <div class="featured-card">
          ...
          <div class="featured-card__body">
            ...
            <a href="/product.php?slug=<?= e($p['slug']) ?>" class="featured-card__cta">
